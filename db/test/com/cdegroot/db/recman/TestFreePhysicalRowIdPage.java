/*
 *  $Id: TestFreePhysicalRowIdPage.java,v 1.1 2000/04/03 12:13:48 cdegroot Exp $
 *
...
public class TestFreePhysicalRowIdPage extends TestCase {
	...
	assert("isfree 0", page.isFree(0));
	assert("isfree 1", page.isFree(1));
	assert("isalloc 2", page.isAllocated(2));
	...
	assert("2: isfree 0", page.isFree(0));
	assert("2: isfree 1", page.isFree(1));
	assert("2: isalloc 2", page.isAllocated(2));
